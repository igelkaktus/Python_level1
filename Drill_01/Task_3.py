...
if age < 30 and 50 < weight < 120
    print(f'{name},возраст{age} вес{weight}, — Вы в хорошем состоянии')
elif age > 30 and (weight < 50 or weight > 120):
    print(f'{name},возраст{age} вес{weight}, — Вам следует заняться собой')
elif age > 40 and (weight < 50 or weight > 120):
    print(f'{name},возраст{age} вес{weight}, — Вам следует обратиться к врачу!')
